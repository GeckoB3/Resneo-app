/**
 * Shared finite-value sets for the compliance domain — the app-side port of the
 * web `src/lib/compliance/constants.ts` (single source of truth, mirroring the
 * CHECK constraints in the compliance migrations). Keep in sync with the web.
 */
 ...
 * (`service_compliance_requirements.online_collection`):
